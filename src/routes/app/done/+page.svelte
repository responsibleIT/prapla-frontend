<script>
    ...
    let particlesInit = async engine => {
        ...
        await new Audio(applause).play();
    };
</script>

<div class="flex flex-col items-center h-screen">
    <div class="flex flex-col h-screen justify-center items-center">
        <h1 class="text-6xl text-center">Je bent klaar</h1>
        <h1 class="text-6xl text-transparent text-center bg-clip-text bg-gradient-to-r from-red-400 via-green-400 to-violet-400">
            Goed zo!</h1>
    </div>
    <div class="grow"></div>
    <AnchorButton href="/">
